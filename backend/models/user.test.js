...
describe("getTransactions", function () {
  test("works", async function () {
    const transactions = await User.getTransactions("u1");
  
    expect(transactions).toHaveLength(2);
  
    const transaction1 = transactions.find(
      (transaction) => transaction.name === "Product1"
    );
    ...
    const transaction2 = transactions.find(
      (transaction) => transaction.name === "Product2"
    );
...
// authenticate
//   ✓ works (3 ms)
//   ✓ unauth if no such user (1 ms)
//   ✓ unauth if wrong password (1 ms)
// register
//   ✓ works (2 ms)
//   ✓ works: adds admin (3 ms)
